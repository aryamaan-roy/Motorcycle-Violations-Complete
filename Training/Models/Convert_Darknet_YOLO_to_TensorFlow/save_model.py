...
flags.DEFINE_string('weights', './data/yolov4-obj_3000.weights', 'path to weights file')
flags.DEFINE_string('output', './checkpoints/yolov4_roi_helmet_no_helmet', 'path to output')
